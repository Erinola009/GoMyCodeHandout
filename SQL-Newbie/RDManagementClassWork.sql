...
CREATE DATABASE "RDManagementClassWork"
USE RDManagementClassWork

-- To transform the provided entity-relationship diagram into a relational model and implement it using SQL.
-- Based on the information given, I will create two tables: Wine and Producer.
...
SELECT p.first_name, p.last_name, SUM(w.degree) AS total_quantity
FROM Producer p
